#include "JU_SP_AVX512.hpp"

JU_SP_AVX512::JU_SP_AVX512() : Convergence("JU_SP_AVX512")
{
    fractal     = "julia";
    dataFormat  = "float";
    modeSIMD    = "AVX512";
...
JU_SP_AVX512::JU_SP_AVX512(ColorMap *_colors, int _max_iters) : Convergence("JU_SP_AVX512")
{
    colors      = _colors;
...
JU_SP_AVX512::~JU_SP_AVX512()
{

}

void JU_SP_AVX512::updateImage(const long double _zoom, const long double _offsetX, const long double _offsetY, const int IMAGE_WIDTH, const int IMAGE_HEIGHT, float* ptr)
{
#ifdef __AVX2__
