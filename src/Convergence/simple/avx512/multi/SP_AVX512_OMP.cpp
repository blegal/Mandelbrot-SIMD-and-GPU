#include "SP_AVX512_OMP.hpp"

#if defined(__AVX2__)
    #include "vectclass/vectorclass.h"
#endif

SP_AVX512_OMP::SP_AVX512_OMP() : Convergence("SP_AVX512_OMP")
{
    fractal     = "mandelbrot";
    dataFormat  = "float";
    modeSIMD    = "AVX512";
...
SP_AVX512_OMP::SP_AVX512_OMP(ColorMap *_colors, int _max_iters) : Convergence("SP_AVX512_OMP")
{
    colors      = _colors;
...
void SP_AVX512_OMP::updateImage(const long double _zoom, const long double _offsetX, const long double _offsetY, const int IMAGE_WIDTH, const int IMAGE_HEIGHT, float* ptr)
{
#ifdef __AVX2__
