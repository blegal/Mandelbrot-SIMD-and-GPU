...
DP_AVX2_OMP_u4::DP_AVX2_OMP_u4()  : Convergence("DP_AVX2_OMP_u4")
{
    dataFormat  = "double";
    modeSIMD    = "AVX2";
    modeOPENMP  = "enable";
...
DP_AVX2_OMP_u4::DP_AVX2_OMP_u4(ColorMap* _colors, int _max_iters)  : Convergence("DP_AVX2_OMP_u4")
{
    colors      = _colors;
...
DP_AVX2_OMP_u4::~DP_AVX2_OMP_u4()
{

}


void DP_AVX2_OMP_u4::updateImage(
