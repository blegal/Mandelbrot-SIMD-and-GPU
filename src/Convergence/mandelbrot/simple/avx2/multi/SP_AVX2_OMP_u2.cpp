...
SP_AVX2_OMP_u2::SP_AVX2_OMP_u2() : Convergence("SP_AVX2_OMP_u2")
{
    fractal     = "mandelbrot";
    dataFormat  = "float";
    modeSIMD    = "AVX2";
...
SP_AVX2_OMP_u2::SP_AVX2_OMP_u2(ColorMap* _colors, int _max_iters) : Convergence("SP_AVX2_OMP_u2")
{
    colors      = _colors;
